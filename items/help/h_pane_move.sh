...
static_content() {
    ...
    set -- \
        ...
        0.0 T " Current pane will be put in" \
        0.0 T " the last window in that session" \
        0.0 T "2 - If a window is selected" \
        0.0 T " Current pane will be added" \
        0.0 T " as the last pane in that window" \
        0.0 T "3 - If a pane is selected," \
        0.0 T " current pane will be inserted" \
        0.0 T " after selected pane"
