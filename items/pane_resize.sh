...
static_content() {
    ...
    set -- \
        ...
        0.0 C U "up" "resize-pane -U 5 $runshell_reload_mnu" \
        0.0 C D "down" "resize-pane -D 5 $runshell_reload_mnu" \
        0.0 C L "left" "resize-pane -L 5 $runshell_reload_mnu" \
        0.0 C R "right" "resize-pane -R 5 $runshell_reload_mnu"
