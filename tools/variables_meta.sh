...
default_floating_pane_incr_horizontal="${default_floating_pane_incr_horizontal:-}"
default_floating_pane_incr_vertical="${default_floating_pane_incr_vertical:-}"
