...
- [Dependencies & Compatibility](#dep-n-conpat)
- [Installing](#installing)
  - [Via TPM (recommended)](#install-tpm)
  - [Manual Installation](#install-manual)
- [whiptail / dialog](#whiptaail)
- [Configuration](#configuration)
  - [Menu location](#menu-location)
  - [Disable caching](#disable-caching)
  - [Using Styling for menus](#styling)
  - [Pointer to the config file](#pointer-config-file)
  - [Logging](#logging)
- [Screen might be too small](#screen-to-small)
- [Modifications](#modifications)
- [Menu building](#menu-building)
  - [Sample script](#sample-script)
  - [Complex param building for menu items](#complex-param-building)
